...
export function NuKlinger() {
	return (
		<div className="song">
			<h1>Nu klinger</h1>
			<p>
				Nu klinger igjennom den gamle stad, påny en studentersang,<br />
				og alle mann alle i rekker og rad, svinger opp under begerklang!<br />
				Og mens borgerne våkner i køia og hører det glade "kang-kang",<br />
				stemmer alle mann, alle mann, alle mann, alle mann, alle mann, alle mann an;
			</p>
			<p>
				<i>Refreng:</i>
				<br />
				Studenter i den gamle stad, ta vare på byens ry! <i>(klapp x2)</i>
				<br />
				Husk på at jenter, øl og dram var kjempenes meny.<br />
				Og faller I alle mann alle, skal det gjalle fra alle mot sky.<br />
				La'kke byen få ro, men la den få merke det er en studenterby!<br />
			...
			<p>
				<i>(Adagio)</i>
				<br />
				Når vi er vandret hen og staden hviler et øyeblikk,<br />
			...
			<p>
				<i>Refreng (Tramp/klapp hele siste refreng):</i>
				<br />
				Studenter i den gamle stad, ta vare på byens ry! <i>(markant klapp x2)</i>
				<br />
				Husk på at jenter, øl og dram var kjempenes meny.<br />
				Og faller I alle mann alle, skal det gjalle fra alle mot sky.<br />
				La'kke byen få ro, men la den få merke det er en studenterby!¨<br />
				<i>(INGEN ØL OG DRAM ETTER SISTE REFRENG! Men ofte utbrytes det i en "Skål!")</i>
			</p>
		</div>
	);
}
