import {Button, Container, Divider, Flex, Heading, Input, Textarea, useToast, VStack} from "@chakra-ui/react";
...
export const UpdateSong = () => {
    ...
    const updateSong = () => {
        ...
        if (userID !== null) {
            updateSongInPamphlet(userID, sanghefte, songID, title, text, artist).catch(console.error);
        }
        toast({
